...
Okay so we have __For__, it's pretty much the same, just in here you have to declare the variable you'll use outside, it's kind of annoying but no problem.
